const RAW_SOURCES = [
  ...
  // ── EU / Европейская политика ─────────────────────────────────────────────
  {
    ...
    listUrls: ['https://euobserver.com/'],
    articleUrl: /^https:\/\/euobserver\.com\/article\/\d+/i
  },
  ...
  // ── Грузия ────────────────────────────────────────────────────────────────
  {
    id: 'agenda-ge',
    name: 'Agenda.ge',
    homepage: 'https://agenda.ge/en',
    listUrls: ['https://agenda.ge/en/'],
    articleUrl: /^https:\/\/agenda\.ge\/en\/news\/\d{4}\/\d+/i
  },
  {
    id: 'civilnet-am',
    name: 'CivilNet Armenia',
    homepage: 'https://www.civilnet.am/en',
    listUrls: ['https://www.civilnet.am/en/'],
    articleUrl: /^https:\/\/www\.civilnet\.am\/en\/news\/\d+\//i
  },
  ...
  // ── Азербайджан ───────────────────────────────────────────────────────────
  {
    id: 'apa-news',
    name: 'APA News',
    homepage: 'https://en.apa.az',
    listUrls: ['https://en.apa.az/'],
    articleUrl: /^https:\/\/en\.apa\.az\/[a-z-]+\/[a-z0-9-]+-\d+\.html/i
  },
  {
    id: 'caliber-az',
    name: 'Caliber.az',
    homepage: 'https://caliber.az/en',
    listUrls: ['https://caliber.az/en/'],
    articleUrl: /^https:\/\/caliber\.az\/en\/post\/\d+\//i
  },

  // ── Казахстан / ЦА ────────────────────────────────────────────────────────
  {
    id: 'silk-road-briefing',
    name: 'Silk Road Briefing',
    homepage: 'https://www.silkroadbriefing.com/news',
    listUrls: ['https://www.silkroadbriefing.com/news/'],
    articleUrl: /^https:\/\/www\.silkroadbriefing\.com\/news\/\d{4}\/\d{2}\/\d{2}\//i
  },
  ...
  // ── Балканы ───────────────────────────────────────────────────────────────
  {
    id: 'exit-al',
    name: 'Exit News',
    homepage: 'https://exit.al/en',
    listUrls: ['https://exit.al/en/'],
    // Покрывает Албанию, Косово, Северную Македонию
    articleUrl: /^https:\/\/exit\.al\/en\/\d{4}\/\d{2}\/\d{2}\//i
  },
  ...
  // ── Аргентина / Бразилия ──────────────────────────────────────────────────
  {
    id: 'infobae-en',
    name: 'Infobae',
    homepage: 'https://www.infobae.com/en',
    listUrls: ['https://www.infobae.com/en/'],
    // Крупнейший испаноязычный медиа с активной EN редакцией
    articleUrl: /^https:\/\/www\.infobae\.com\/en\/\d{4}\/\d{2}\/\d{2}\//i
  },
  {
    id: 'rio-times',
    name: 'Rio Times Online',
    homepage: 'https://riotimesonline.com',
    listUrls: ['https://riotimesonline.com/'],
    articleUrl: /^https:\/\/riotimesonline\.com\/[a-z-]+\/[a-z0-9-]+\//i
  },
