const RAW_SOURCES = [
  ...
  // ── Азербайджан ───────────────────────────────────────────────────────────
  {
    ...
    listUrls: ['https://en.apa.az/world/', 'https://en.apa.az/'],
...
const FEED_URLS = {
  ...
  // EU / Европа
  euobserver:          ['https://euobserver.com/rss.xml', 'https://euobserver.com/articles/rss.xml'],
  // Грузия / Армения
  ...
  // Балканы
  'exit-al':           ['https://exit.al/en/rss/', 'https://exit.al/feed/'],  // feed/ 404
  // Аргентина / Бразилия
  'infobae-en':        ['https://www.infobae.com/en/rss/'],  // feeds/rss/english/ 404
