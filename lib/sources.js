const RAW_SOURCES = [
  ...
  },
  {
    ...
    articleUrl: /^https:\/\/spectator\.sme\.sk\/c\/[a-z0-9-]+/i
  },
  {
  ...
  },
  {
    id: 'novinite',
    name: 'Novinite',
    homepage: 'https://www.novinite.com',
    listUrls: ['https://www.novinite.com/'],
    articleUrl: /^https:\/\/www\.novinite\.com\/articles\/\d+/i
  },
  {
    id: 'romania-insider',
...
const DATE_POLICIES = {
  ...
  ekathimerini: {
    summary: 'Greece EN; JSON-LD datePublished',
    articleDateSelectors: ['meta[property="article:published_time"]', 'time[datetime]']
  },
  novinite: {
