const RAW_SOURCES = [
  ...
  },
  {
    id: 'cyprus-mail',
    name: 'Cyprus Mail',
    homepage: 'https://cyprus-mail.com',
    listUrls: ['https://cyprus-mail.com/'],
    articleUrl: /^https:\/\/cyprus-mail\.com\/\d{4}\/\d{2}\/\d{2}\//i
  },
  {
    id: 'delfi-english',
    name: 'Delfi English',
    homepage: 'https://en.delfi.lt',
    listUrls: ['https://en.delfi.lt/', 'https://en.delfi.lv/'],
    articleUrl: /^https:\/\/en\.delfi\.(lt|lv)\//i
  },
    {
    id: 'channel4-news',
    name: 'Channel 4 News',
  ...
  // ── Центральная Европа ────────────────────────────────────────────────────
  {
    ...
    homepage: 'https://www.channel4.com/news',
    listUrls: ['https://www.channel4.com/news/'],
    articleUrl: /^https:\/\/www\.channel4\.com\/news\/[a-z0-9-]+/i
  },
  {
    id: 'notes-poland',
  ...
  },
  {
    ...
    homepage: 'https://www.scmp.com/news/world/europe',
    listUrls: ['https://www.scmp.com/news/world/europe'],
    articleUrl: /^https:\/\/www\.scmp\.com\/news\/world\/europe\//i
  },
  {
    id: 'european-conservative',
    name: 'The European Conservative',
    homepage: 'https://europeanconservative.com',
    listUrls: ['https://europeanconservative.com/news/'],
    articleUrl: /^https:\/\/europeanconservative\.com\/articles\//i
  },
    {
    id: 'washington-times',
    name: 'The Washington Times',
    homepage: 'https://www.washingtontimes.com',
    listUrls: ['https://www.washingtontimes.com/news/world/'],
    articleUrl: /^https:\/\/www\.washingtontimes\.com\/news\/\d{4}\//i
  },
    {
    id: 'radio-prague',
...
const DATE_POLICIES = {
  ...
  'washington-times': {
    summary: 'US conservative; WordPress; article:published_time or time[datetime]',
    articleDateSelectors: ['meta[property="article:published_time"]', 'time[datetime]', 'script[type="application/ld+json"]']
  },
  'brussels-times': {
  ...
  ekathimerini: {
    summary: 'Greece EN; JSON-LD preferred; time[datetime] gives date only',
    articleDateSelectors: ['meta[property="article:published_time"]', 'script[type="application/ld+json"]', 'time[datetime]']
  },
  novinite: {
  ...
  'euobserver': {
    summary: 'EU politics news site; RSS open; article:published_time or time[datetime]',
    articleDateSelectors: ['meta[property="article:published_time"]', 'time[datetime]', 'script[type="application/ld+json"]']
  },
  'washington-times': {
    summary: 'US conservative; WordPress; article:published_time or time[datetime]',
  ...
  'brussels-times': {
    summary: 'Belgium EN; WordPress; JSON-LD datePublished or article:published_time',
    articleDateSelectors: ['meta[property="article:published_time"]', 'script[type="application/ld+json"]', 'time[datetime]']
  },
  'cyprus-mail': {
    summary: 'Cyprus EN; WordPress; article:published_time in meta',
    articleDateSelectors: ['meta[property="article:published_time"]', 'time[datetime]', 'script[type="application/ld+json"]']
  },
  'delfi-english': {
    summary: 'Baltic EN (Lithuania/Latvia); article:published_time or time[datetime]',
    articleDateSelectors: ['meta[property="article:published_time"]', 'time[datetime]', 'script[type="application/ld+json"]']
  },
  'european-conservative': {
    summary: 'Conservative EU news magazine; WordPress; JSON-LD datePublished',
    articleDateSelectors: ['meta[property="article:published_time"]', 'time[datetime]']
  },
  'scmp-europe': {
    summary: 'SCMP Europe section; JSON-LD datePublished preferred; meta article:published_time fallback',
    articleDateSelectors: [
      'meta[property="article:published_time"]',
